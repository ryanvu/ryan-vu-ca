export const projects = [
  {
    title: "meal.",
    year: '2024', desc: 'Meal plan generator written in Elixir, Phoenix LiveView',
    work: 'Plan, Design, Code / Learning Project',
    imgs: [
  ...
  },
  {
    ...
    year: '2022',
    desc: 'Contracted to create admin features requested by business owner in Vue.js + Firebase',
    work: 'Plan, Code, Upgrade',
    imgs: [
  ...
  },
  {
    ...
    year: '2021',
    desc: 'Portfolio for Natalie Mitchell Music written with Next.js',
    work: 'Design, Code, and Deploy',
    imgs: [
  ...
  // },
  {
    title: "Deluxe Time",
    year: '2019',
    desc: 'Landing page for small watch-repair business written with React.js',
    work: 'Design, Code, and Deploy',
    imgs: [
